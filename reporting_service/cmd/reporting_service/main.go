...
import (
	...
	int_service "esgrs/reporting_service/internal/pkg/service"
	service "esgrs/reporting_service/service"
	transport "esgrs/reporting_service/transport"
	http "esgrs/reporting_service/transport/http"
	"fmt"
...
func main() {
	...
	var svc reportingservice.ReportingService // TODO: = service.NewReportingService () // Create new service.
	svc = int_service.ReportingServiceImplementation{}
	...
	httpAddr := ":8082" // TODO: use normal address
	// Start http server.
	g.Go(func() error {
