...
import (
	...
	int_service "esgrs/data_processing_service/internal/pkg/service"
	service "esgrs/data_processing_service/service"
	transport "esgrs/data_processing_service/transport"
	http "esgrs/data_processing_service/transport/http"
	"fmt"
