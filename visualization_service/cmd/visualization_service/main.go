...
import (
	...
	int_service "esgrs/visualization_service/internal/pkg/service"
	service "esgrs/visualization_service/service"
	transport "esgrs/visualization_service/transport"
	http "esgrs/visualization_service/transport/http"
	"fmt"
...
func main() {
	...
	var svc visualizationservice.VisualizationService // TODO: = service.NewVisualizationService () // Create new service.
	svc = int_service.VisualizationServiceImplementation{}
	...
	httpAddr := ":8083" // TODO: use normal address
	// Start http server.
	g.Go(func() error {
