...
func NewHTTPClient(u *url.URL, opts ...httpkit.ClientOption) transport.EndpointsSet {
	return transport.EndpointsSet{GenerateVisualizationEndpoint: httpkit.NewClient(
		"POST", u,
		_Encode_GenerateVisualization_Request,
		_Decode_GenerateVisualization_Response,
		opts...,
	).Endpoint()}
}
